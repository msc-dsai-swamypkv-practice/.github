...
The repositories span **six trimesters** and mirror a structured, hands-on path through statistics, mathematics, machine learning, deep learning, data engineering, and applied AI — **for Swamy’s own traceability and practice**, not as a service to third parties.
...
## 🗂️ Structure of This Organization

Repositories are organized by **trimester and subject** for **Swamy’s** clarity and traceability (not as a prescribed layout for others).

### 📘 Trimester Repositories

- `t1-*` → Foundations (Probability, Statistics, Linear Algebra, Python)
- `t2-*` → Inferential Statistics, Machine Learning Foundations, Data Engineering
- `t3-*` → Supervised & Unsupervised Learning
- `t4-*` → Deep Learning, Natural Language Processing, Computer Vision
- `t5-*` → Advanced Machine Learning, Research Methods, Electives
- `t6-*` → Capstone Project

### 🧪 Supporting Repositories

- `lab-*` → Exploratory experiments and side studies
- `lib-*` → Personal utilities and shared components **for this workspace**
- `capstone-*` → Final applied project(s)

---

## 📐 How Swamy uses each repository

The layout below is **for personal consistency**, not a pattern others should adopt:
...
- Repositories may be **public or private** for Swamy’s convenience (backup, tooling, habits). **Public visibility is not an invitation** to use this organization as a learning resource or reference corpus for anyone else.
- Early-trimester repositories may contain **learning-stage work** (drafts, mistakes, and experiments are expected).
- **No warranty** — nothing here is asserted as correct, complete, or suitable for any purpose beyond Swamy’s own study.
