...
The **bits-dsai** organization is **Swamy’s personal learning workspace only** — not a shared curriculum for others. See `profile/README.md` and `.cursor/rules/00_org-profile-repository.mdc`.
